...
<body style="background-color: #F3F3F3;" class="open-modal">
    <header></header>
    <div class="contenedor-toda-informacion-asignatura">
        ...
        if(isset($_SESSION['rol'])){
            ...
            <div class="opciones" data-carrera="<?php echo $row[0]->acro?>">
                <button class="btn btn-edit" id="btn-aprobar" value="<?php echo $row[0]->clave?>"><i
                        class="material-icons">check</i>Aprobada</button>
                <button class="btn btn-delete" id="btn-reprobar" value="<?php echo $row[0]->clave?>"><i
                        class="material-icons">close</i>Reprobada</button>
            </div>
            <?php } ?>
            <span><?php 
                    if($status != null)
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td colspan="3">Asignatura antecedente</td>
                    </tr>
                    <tr>
                        <td colspan="3"><?php echo (isset($antecedente->clave)) ? $antecedente->nombre : 'Ninguna' ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">Asignatura subcecuente</td>
                    </tr>
                    <tr>
                        <td colspan="3"><?php echo (isset($subsecuente->clave)) ? $subsecuente->nombre : 'Ninguna' ?>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="pdf">
            <?php if($row[0]->pdf != ''){ ?>
            <embed src="../../php/Archivos/<?php echo $_GET['asignatura']?>.pdf#toolbar=0&navpanes=0&scrollbar=0   "
                type="application/pdf" height="" width="75%">
            <?php }else{ ?>
            <div>
